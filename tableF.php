        ...
        <div class="side-content">
            ...
            <div class="side-menu">
                <ul>
                    ...
                    <li>
                    <a href="tableF.php" class="active">
                            <span class="las la-user-cog"></span>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addUserModalLabel">Add Facilitator</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="addUserForm" method="post" action="code2.php">
                        <div class="mb-3">
    ...
    <div class="table-container">
        ...
        <table>
            ...
            <tbody id="userTable">
                <?php
                    include('database/config.php');
                    $sql="SELECT facilitateur.id_F, facilitateur.username, facilitateur.password, facilitateur.status ,niveau.titre, facilitateur.gender
                    FROM facilitateur join niveau on facilitateur.idN=niveau.id_N
                    ";
                ...
                <tr>
                    ...
                    <td >  <a href="updateF.php?id_F=<?php echo $row['id_F'] ?>" class="link-light btn btn-warning">
        <i class="fa-solid fa-edit"></i>
    </a>
    <a href="removeF.php?id_F=<?php echo $row['id_F'] ?>" class="link-light btn btn-danger">
